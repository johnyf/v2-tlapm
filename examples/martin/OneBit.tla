...
TypeOK == x \in [ProcSet -> {TRUE,FALSE}] /\ pc \in {"nc", "e1", "e2", "e3", "e4", "cs", "f"}

THEOREM TypeOK => ENABLED <<e1(0)>>_vars BY DEF e1, vars

THEOREM TypeOK => \E pcp, xp:
                    /\ pc[0] = "e1"
                    /\ xp = [x EXCEPT ![0] = TRUE]
                    /\ pcp = [pc EXCEPT ![0] = "e2"]
                    /\ <<xp, pcp>> # <<x, pc>> BY Isa DEF TypeOK, ProcSet
...
\* Last modified Thu Mar 12 12:12:16 CET 2015 by marty
