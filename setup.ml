...
(* OASIS_START *)
(* DO NOT EDIT (digest: 15824b3e5df3ff38df3c332d92ba571f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Damien Doligez"; "Tomer Libal"];
          homepage = None;
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "tlapm.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\000X\210\\\002\199\014\0172\130\217\020\213\022j}";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
